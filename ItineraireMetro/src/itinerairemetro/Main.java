...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (choix != 0) {
            System.out.println(" Que voules vous faire : ");
            System.out.println(" (1) Definir itineraire ");
